"""
Django settings for pulproject project.
...
SECRET_KEY = 'django-insecure-$pfvjxld@o_p+zd-2m6pa-ixk#v)^-g4)ovr&p*%g!+rp&zeb^'
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'powerusedlubricants.com']
...
WSGI_APPLICATION = 'pulproject.wsgi.application'
